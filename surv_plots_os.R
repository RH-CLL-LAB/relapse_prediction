...
heatmap_plot <- ggplot(master_df, aes(x = `Risk Group`, y = `Age Group`, fill = surv)) + 
  ...
  guides(fill=guide_legend(title="Overall\nSurvival (2 years)")) +
...
heatmap_plot %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_OS.pdf",
           width = 20, height = 10)

heatmap_plot_n %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_n_OS.pdf",
           width = 20, height = 10)
...
heatmap_plot %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_5_years_OS.pdf",
           width = 20, height = 10)

heatmap_plot_n %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_n_5_years_OS.pdf",
           width = 20, height = 10)
...
heatmap_plot %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_10_years_OS.pdf",
           width = 20, height = 10)

heatmap_plot_n %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_n_10_years_OS.pdf",
           width = 20, height = 10)
...
for (time in c(2, 5, 10)){
  ...
  panels <- list(forest_panel(width = 0.005), 
                 forest_panel(width = 0.001, display = label_list, parse = TRUE, heading = "Model"), 
                 forest_panel(width = 0.001, display = level), 
                 forest_panel(width = 0.005, display = n, hjust = 1, heading = "N"), 
                 forest_panel(width = 0.02, item = "vline", hjust = 0.5), 
                 forest_panel(width = 0.90, item = "forest", hjust = 0.5, heading = paste0(time, "-year Overall Survival")), 
                 forest_panel(width = 0.02, item = "vline", hjust = 0.5), 
                 forest_panel(width = 0.005, display = if_else(reference, "Reference", sprintf("%d%% (%d%%-%d%%)", round(trans(estimate)), round(trans(conf.low)), round(trans(conf.high)))), display_na = NA, heading = "Percent (95% CI)")) 
  ...
  forest_plot %>%
    ggexport(filename = paste0("projects/lyfo_relapse_prediction/scripts/plots/forest_plot_",time,"_years_OS.pdf"),
             width = 15, height = 6)
...
RIPI_KM %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/KM_TFS_OS.pdf",
...
heatmap_plot %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_all_OS.pdf",
           width = 20, height = 10)

heatmap_plot_n %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_all_n_OS.pdf",
           width = 20, height = 10)
...
heatmap_plot %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_all_5_years_OS.pdf",
           width = 20, height = 10)

heatmap_plot_n %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_all_n_5_years_OS.pdf",
           width = 20, height = 10)
...
heatmap_plot %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_all_10_years_OS.pdf",
           width = 20, height = 10)

heatmap_plot_n %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/survival_all_n_10_years_OS.pdf",
           width = 20, height = 10)
...
for (time in c(2, 5, 10)){
  ...
  forest_plot %>%
    ggexport(filename = paste0("projects/lyfo_relapse_prediction/scripts/plots/forest_plot_all_",time,"_years_OS.pdf"),
             width = 15, height = 6)
...
RIPI_KM %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/KM_TFS_all_OS.pdf",
           width =8*2.5, height =7*2)


km_lyfo = read_csv("/ngc/people/mikwer_r/projects/lyfo_relapse_prediction/scripts/results/km_data_lyfo_FCR_under_75_OS.csv")
...
for (time in c(2, 5, 10)){
  ...
  forest_plot %>%
    ggexport(filename = paste0("projects/lyfo_relapse_prediction/scripts/plots/forest_plot_under_75_",time,"_years_OS.pdf"),
             width = 15, height = 6)
...
RIPI_KM %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/KM_TFS_under_75_OS.pdf",
           width =8*2.5, height =7*2)


km_lyfo = read_csv("/ngc/people/mikwer_r/projects/lyfo_relapse_prediction/scripts/results/km_data_lyfo_FCR_all_under_75_OS.csv")
...
for (time in c(2, 5, 10)){
  ...
  forest_plot %>%
    ggexport(filename = paste0("projects/lyfo_relapse_prediction/scripts/plots/forest_plot_all_under_75_",time,"_years_OS.pdf"),
             width = 15, height = 6)
...
RIPI_KM %>%
  ggexport(filename = "projects/lyfo_relapse_prediction/scripts/plots/KM_TFS_all_under_75_OS.pdf",
           width =8*2.5, height =7*2)
